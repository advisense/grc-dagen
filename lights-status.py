...
def run():
    ...
    if lights:
        for i, light in enumerate(lights):
            print('{0}: {1} | State: {2} | Dimmer: {3} | Color (XY): {4}'.format(i, light.name, light.light_control.lights[0].state,light.light_control.lights[0].dimmer, light.light_control.lights[0].xy_color))
